  ...
  <html class="no-js"  <?php language_attributes(); ?>>
    ...
    <head>
        ...
        <?php if ( ! function_exists( 'has_site_icon' ) || ! has_site_icon() ) { ?>
            <!-- Icons & Favicons -->
            <link rel="icon" href="<?php echo esc_attr( get_template_directory_uri() ); ?>/favicon.png">
            <link href="<?php echo esc_attr( get_template_directory_uri() ); ?>/assets/images/apple-icon-touch.png" rel="apple-touch-icon" />
            <!--[if IE]>
                <link rel="shortcut icon" href="<?php echo esc_attr( get_template_directory_uri() ); ?>/favicon.ico">
            <![endif]-->
