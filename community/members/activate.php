  ...
  <div class="page" id="activate-page">
    ...
    <div id="template-notices" role="alert" aria-atomic="true">
	  ...
	  <?php if ( bp_account_was_activated() ) : ?>
		  ...
		  <?php else : ?>
          <p><?php printf( __( 'Your account was activated successfully! You can now log in below with the username and password you provided when you signed up.', 'buddypress' ), wp_login_url( bp_get_root_domain() ) ); ?></p>
		  <?php endif; ?>
